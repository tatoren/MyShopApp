...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckOutAndCreatOrder()
        {
            ...
            customers.Insert(new Customer { ID = "1", Email = "fake@deepmail.com", PostalCode = "t6ei7r" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("fake@deepmail.com", "Forms"), null);
